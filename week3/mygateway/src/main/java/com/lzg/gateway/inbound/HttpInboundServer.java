...
public class HttpInboundServer {
    ...
    public HttpInboundServer(int port, List<String> proxyServers, HttpEndpointRouter httpEndpointRouter) {
        this(port, proxyServers);
    ...
    public void run() throws Exception {
        ...
        try {
            ...
            b.group(bossGroup, workerGroup).channel(NioServerSocketChannel.class)
                    ...
                    .childHandler(new HttpInboundInitializer(this.proxyServers,httpEndpointRouter));
