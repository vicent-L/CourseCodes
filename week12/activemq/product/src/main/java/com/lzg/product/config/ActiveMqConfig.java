package com.lzg.product.config;
...
public class ActiveMqConfig {
    ...
    //    JmsMessagingTemplate配置
    @Bean(MQConstant.JMS_MESSAGE_TOPIC_TEMPLATE)
    public JmsMessagingTemplate jmsMsgTopicTemplate() {
        JmsMessagingTemplate jmsTemplate = new JmsMessagingTemplate();
       jmsTemplate.setJmsTemplate(jmsTopicTemplate());
        return jmsTemplate;
    }

    @Bean(MQConstant.JMS_MESSAGE_QUEUE_TEMPLATE)
    public JmsMessagingTemplate jmsMsgQueueTemplate() {
        JmsMessagingTemplate jmsTemplate = new JmsMessagingTemplate();
        jmsTemplate.setJmsTemplate(jmsQueueTemplate());
        return jmsTemplate;
    }
